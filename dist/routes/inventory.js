...
router.get('/raw', (0, auth_1.authorizeRole)('PLANT_ADMIN', 'SHIFT_SUPERVISOR', 'QC_INSPECTOR', 'SALES_REP'), async (req, res) => {
    try {
...
router.post('/raw', (0, auth_1.authorizeRole)('PLANT_ADMIN', 'SHIFT_SUPERVISOR'), async (req, res) => {
    try {
...
router.get('/production', (0, auth_1.authorizeRole)('PLANT_ADMIN', 'SHIFT_SUPERVISOR', 'QC_INSPECTOR', 'SALES_REP'), async (req, res) => {
    try {
