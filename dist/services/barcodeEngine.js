...
class BarcodeEngine {
     ...
     */
    static generateRollSticker(shift, machine) {
        const date = new Date();
     ...
     */
    static generatePalletSticker(shift, machine, totalWeight) {
...
exports.BarcodeEngine = BarcodeEngine;
